...
//כאן יש את הגרסאות הקודמות...
// import mongoose from "mongoose";
// import Allocation from "./Allocation.js";
// // סכמת משנה לשיבוץ (כדי לשמור על סדר)
// //הטבלה הזו מכילה את כל השיבוצים לחדר זה.
...
//   // מערך שיבוצים (Allocations) - כל השיבוצים של החדר הזה
//   Allocation: [Allocation.schema], // אנחנו משתמשים בסכמת המשנה של Allocation
...
// }, { 
//   timestamps: true,
//   // הגדרות אלו מאפשרות ל-Virtuals לעבור לצד הלקוח (React)
//   toJSON: { virtuals: true },
//   toObject: { virtuals: true }
// });

// // הגדרת קשר וירטואלי - "הגשר" לטבלת השיבוצים
// RoomSchema.virtual('allocations', {
//   ref: 'Allocation',      // המודל שאליו מקשרים
//   localField: '_id',      // השדה בתוך Room
//   foreignField: 'room'    // השדה בתוך Allocation שמצביע על החדר
// });
